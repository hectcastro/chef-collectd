...
* `recipe[collectd::attribute_driven]` will install collectd via node attributes. (Note, you still need to include the default recipe to install. attribute_driven only actually CONFIGURES collectd)
